...
async function run() {
    try {
        console.log('Step 1: Creating/Updating Unit "برج 122 المباحث"...');
        ...
        console.log('Step 2: Adding Unit Expenses...');
        const unitExpenses = [
            { unit_id: unitId, category: 'Construction', amount: 220000 * RATE, date: '2025-12-28', description: 'Initial Expense (Image 1)', type: 'Variable' },
            { unit_id: unitId, category: 'Construction', amount: 190000 * RATE, date: '2025-12-30', description: 'Follow-up Expense (Image 1)', type: 'Variable' },
            { unit_id: unitId, category: 'Construction', amount: 20000 * RATE, date: '2025-12-31', description: 'End of year Expense (Image 1)', type: 'Variable' },
            { unit_id: unitId, category: 'Construction', amount: 40000 * RATE, date: '2026-02-04', description: 'Early 2026 Expense (Image 1)', type: 'Variable' }
        ];
        ...
        console.log('Step 4: Adding Supplier Invoices...');
        const invoices = [
        ...
        const { error: purError } = await supabase.from('purchases').insert(invoices);
