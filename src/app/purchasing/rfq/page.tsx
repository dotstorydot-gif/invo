...
export default function Page() {
    ...
    const filteredData = data.filter((item) => item.type === 'RFQ');
            ...
            <main className="flex-1 p-8 overflow-y-auto">
                <header className="flex justify-between items-center mb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold gradient-text">Request for Quotations</h2>
                            <p className="text-gray-400 text-sm mt-1">Manage all your requests for quotation here.</p>
                        </div>
                    </div>
                </header>
                ...
                <div className="glass p-8 flex flex-col items-center justify-center min-h-[400px] border-border-custom text-center">
                    ...
                    <p className="text-gray-400 max-w-md mb-8">
                        The Request for Quotations module is currently running. Full interactive features are rolling out shortly.
