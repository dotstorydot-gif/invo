...
const translations: Translations = {
    en: {
        ...
        search_salary_register_placeholder: "Search employee or month...",
        period: "Period",
        net_pay: "Net Pay",
        paid: "Paid",
        status_label: "Status",
        generate_register: "Generate Register",
        transferred: "Transferred",
        payroll_partial: "Partial",
        ...
        salary_payment_for: "Salary payment for",
        ...
        generate_slip_failed: "Failed to generate slip",
        no_active_contract_error: "No active contract found for this employee.",
    ...
    ar: {
        ...
        salary_register_title: "سجل الرواتب",
        salary_register_subtitle: "تتبع المدفوعات وإدارة الأرصدة",
        search_salary_register_placeholder: "ابحث عن موظف أو شهر...",
        period: "الفترة",
        net_pay: "صافي الراتب",
        paid: "المدفوع",
        status_label: "الحالة",
        generate_register: "إنشاء السجل",
        transferred: "تم التحويل",
        payroll_partial: "جزئي",
        payroll_pending: "معلق",
        syncing_register: "جاري مزامنة السجل...",
        no_salary_records_found: "لم يتم العثور على سجلات رواتب تطابق بحثك.",
        salary_payment_for: "دفعة راتب لـ",
        payment_processed_success: "تمت معالجة الدفعة بنجاح",
        payment_failed: "فشلت معالجة الدفعة",
        salary_slip_generated_success: "تم إنشاء قسيمة الراتب بنجاح",
        generate_slip_failed: "فشل إنشاء القسيمة",
        no_active_contract_error: "لم يتم العثور على عقد نشط لهذا الموظف.",
